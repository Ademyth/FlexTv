  ...
  return (
    ...
    <div>
        ...
        <div className='relative flex items-center group'>
            ...
            <MdChevronRight className='bg-white right-0 white-0 rounded-full absolute opacity-50 hover:opacity-100 cursor-pointer z-10 hidden group-hover:block' size={40}
                onClick={slideRight}
            />
        </div>
    </div>
